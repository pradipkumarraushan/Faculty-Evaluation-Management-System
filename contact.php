...
$mail->addAddress("admin@pradip.epizy.com"); // Enter email id TO WHOM U R SENDING MAIL.
...
<form method="post">
	...
	<div class="row" style="margin-top:10px ;margin-left:90px">
		...
		<b>Mobile:</b> <a style="color: black" href="tel:+18458182186">+1(845) 818-2186</a><br/>

		<b>Email:</b><a style="color: black" href="mailto:admin@pradip-github.epizy.com">admin@pradip-github.epizy.com</a><br/>

		<b>Website:</b> <a style="color: black" href="http://pradip.epizy.com/">Admin</a>
