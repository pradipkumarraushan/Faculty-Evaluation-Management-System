...
//check email id alereay exists or not

$sql=mysqli_query($conn,"SELECT * from user where  email='$e' ");

$r=mysqli_num_rows($sql);

//check employee id alereay exists or not

$sql1=mysqli_query($conn,"SELECT * from user where empid = '$empid' ");
...
$error_message = "Your Registration is unsuccessful !! <br>This <font color='blue'>".$e." </font> Email Id  is already registered" ; 
...
$error_message = "Your Registration is unsuccessful !! <br>This <font color='blue'>".$empid." </font> Employee Id is already registered  ";
